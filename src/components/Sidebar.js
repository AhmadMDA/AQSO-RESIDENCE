...
import { faBook, faBoxOpen, faChartPie, faUser, faHandHoldingUsd, faSignOutAlt, faTable, faTimes, faCalendarAlt, faMapPin, faLock, faInbox, faRocket } from "@fortawesome/free-solid-svg-icons";
            ...
            <Nav className="flex-column pt-3 pt-md-0">
             <div className="mb-4 d-flex align-items-center px-2">
               <Link to={Routes.DashboardOverview.path} onClick={() => setShow(false)} className="d-flex align-items-center text-decoration-none">
                 ...
                 />
                 <span className="text-white fw-bold" style={{ fontSize: '1rem' }}>AQSO RESIDENCE</span>
               </Link>
             </div>
