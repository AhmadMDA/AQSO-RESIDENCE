...
import { faAngleDown, faAngleUp, faNotesMedical,faArrowDown, faArrowUp, faEdit, faEllipsisH, faExternalLinkAlt, faEye, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
        ...
        <td>
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item>
                <FontAwesomeIcon icon={faNotesMedical} className="me-2" /> Print Nota
              </Dropdown.Item>
        ...
        <Table hover className="user-table align-items-center">
          <thead>
            <tr>
              ...
              <th className="border-bottom">Sudah Diterima Dari</th>
