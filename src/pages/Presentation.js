        ...
        <Container>
          ...
          <Row className="justify-content-between align-items-center mb-5 mb-lg-7">
            <Col lg={5}>
              ...
              <Button as={Link} to={Routes.Forms.path} variant="secondary" className="mb-5 mb-lg-0" target="_blank"><FontAwesomeIcon icon={faReact} className="me-1" /> Components Auth</Button>
            </Col>
